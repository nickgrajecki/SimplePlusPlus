...
function getHome(){
    var home = "40 Maidstone Road, Norwich, UK";
...
//console.log(moonLanding.getTime());
        ...
        function initMap() {
            ...
            var locations = [
                ...
                ['<h3>Catholic Cathedral of St John the Baptist</h3>', 'historicMarkers', 52.6291, 1.2840],
                ['<h3>Norwich Castle</h3>', 'historicMarkers', 52.6287, 1.2964],
                ['<h3>The Guildhall</h3>', 'historicMarkers', 52.6290, 1.2925],
                ...
                //Gardens
                ['<h3>The Plantation Garden</h3>', 'gardenMarkers', 52.6290, 1.2821],
                ['<h3>East Ruston Old Vicarage Garden</h3>', 'gardenMarkers', 52.8057, 1.5086],
                ['<h3>Horsey Beach</h3>', 'gardenMarkers', 52.7597, 1.6521],
                ['<h3>The Broads National Park</h3>', 'gardenMarkers', 52.6049, 1.6089],
                ['<h3>Sheringham Park</h3>', 'gardenMarkers', 52.9272, 1.1750],
                ['<h3>Eaton Park</h3>', 'gardenMarkers', 52.6195, 1.2548],
                ['<h3>Earlham Park</h3>', 'gardenMarkers', 52.6255, 1.2340],
                ['<h3>Chapelfield Gardens</h3>', 'gardenMarkers', 52.6260, 1.2895],
                ['<h3>Norfolk Showground</h3>', 'gardenMarkers', 52.6467, 1.1776],
                ['<h3>Mousehold Heath</h3>', 'gardenMarkers', 52.6422, 1.3223],
                
                //Museum
                ['<h3>Sainsbury Centre for Visual Arts</h3>', 'museumMarkers', 52.6203, 1.2347],
                ['<h3>Museum of Norwich at the Bridewell</h3>', 'museumMarkers', 52.6301, 1.2951],
                ['<h3>City of Norwich Aviation Museum</h3>', 'museumMarkers', 52.6803, 1.2770],
                ...
                ['<h3>Giggling Squid</h3>', 'restaurantsMarkers', 52.6310, 1.2994],
                ['<h3>Grosvenor Fish Bar</h3>', 'restaurantsMarkers', 52.6300, 1.2916],
                ['<h3>Brick Pizza</h3>', 'restaurantsMarkers', 52.6282, 1.2927],
                ["<h3>Frankie & Benny's<h3>", 'restaurantsMarkers', 52.6262, 1.3050],
                ...
                ['<h3>Norwich Puppet Theatre</h3>', 'theatreMarkers', 52.6360, 1.3001],
                ...
                ['<h3>Cinema City</h3>', 'theatreMarkers', 52.6305, 1.2960],
                ['<h3>Vue Cinema</h3>', 'theatreMarkers', 52.6268, 1.2964],
                ['<h3>Hollywood Screen Cinema</h3>', 'theatreMarkers', 52.6362, 1.2956],
                ['<h3>Riverside Entertainment Centre</h3>', 'theatreMarkers', 52.6256, 1.3060],
                ...
                ['<h3>Nuffield Health Fitness & Wellbeing Gym</h3>', 'sportMarkers', 52.6348, 1.3071],
                ['<h3>Wentworth Private Swimming Pool</h3>', 'sportMarkers', 52.6170, 1.2749],
                ...
                ['<h3>Bannatyne Health Club</h3>', 'sportMarkers', 52.6300, 1.3683],
                ['<h3>Wensum Sports Centre</h3>', 'sportMarkers', 52.6235, 1.3032],
                ['<h3>Health Central Fitness and Health</h3>', 'sportMarkers', 52.6685, 1.2735],
                ...
                ['<h3>Tesco Metro</h3>', 'shopMarkers', 52.629190, 1.292801],
                ...
                ['<h3>Aldi</h3>', 'shopMarkers', 52.637543, 1.240340],
                ...
                ['<h3>Co-op Food</h3>', 'shopMarkers', 52.629099, 1.269270],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.632848, 1.281190],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 2.621804, 1.251340],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.623035, 1.276306],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.651235, 1.291634],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.624646, 1.260497],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.626765, 1.306204],
                ['<h3>East Of England Co-operative Convenience Store</h3>', 'shopMarkers', 52.629414, 1.247536],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.665167, 1.288790],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.618007, 1.297319],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.647926, 1.234749],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.653238, 1.279458],
                ['<h3>East of England Co-op Daily</h3>', 'shopMarkers', 52.657950, 1.276700],
                ['<h3>East of England Co-op Daily Foodstore</h3>', 'shopMarkers', 52.608300, 1.282647],
                ['<h3>Co-op Food</h3>', 'shopMarkers', 52.644863, 1.302335],
                ['<h3>East of England Co-operative Convenience Store</h3>', 'shopMarkers', 52.647926, 1.234749],
                ['<h3>East of England Co-op Daily Foodstore</h3>', 'shopMarkers', 52.634400, 1.346503],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.641174, 1.337174],
                ['<h3>East of England Co-op Foodstore</h3>', 'shopMarkers', 52.665215, 1.263360],
            
                //Hosptials
                ['<h3>Norfolk and Norwich University Hospitals NHS Foundation Trust</h3>', 'hospitalMarkers', 52.6181, 1.2211],
                ...
                ['<h3>Bupa Health Centre Norwich Watton Road</h3>', 'hospitalMarkers', 52.6271, 1.2238],
                ['<h3>NNUH</h3>', 'hospitalMarkers', 52.6181, 1.2211],
                ['<h3>Norfolk Community Health and Care NHS Trust</h3>', 'hospitalMarkers', 52.6342, 1.2624],
                ['<h3>Newmarket House Health Care Ltd</h3>', 'hospitalMarkers', 52.6147, 1.2670],
                ['<h3>Hammerton Court</h3>', 'hospitalMarkers', 52.6323, 1.2622],
                ['<h3>Norfolk and Suffolk Hospital</h3>', 'hospitalMarkers', 52.6595, 1.2507],
                ['<h3>St Andrews Lodge, Julian Hospital</h3>', 'hospitalMarkers', 52.6331, 1.2631],
                ['<h3>Bowthorpe Health Centre</h3>', 'hospitalMarkers', 52.6367, 1.2179],
                ['<h3>Norfolk Community Health & Care</h3>', 'hospitalMarkers', 52.6342, 1.2624],
                ['<h3>Julian Hospital</h3>', 'hospitalMarkers', 52.6330, 1.2630]
            ];
            ...
            function codeAddress(address) {
                geocoder.geocode( { 'address': address}, function(results, status) {
                    if (status == google.maps.GeocoderStatus.OK) {
                        ...
                        var markerInput = new google.maps.Marker({// place a marker on the map at the address
                            map: map,
        ...
        if (this.travelMode === 'TRANSIT') {
            this.directionsService.route({
              ...
              if (status === 'OK') {
                ...
                $('#print').empty();
                $('#print').append('<a href="javascript:window.print()"><img src="images/print.png" alt="print this page" id="print-button" />&nbsp;<span class="printText">Print<span></a>');
        } else {
            this.directionsService.route({
                origin: {'placeId': this.originPlaceId},
                destination: {'placeId': this.destinationPlaceId},
